...
ResizeListener::ResizeListener() : 
	m_widthShrinkAnimation(Animator::COMPONENT_WIDTH, Easing::OUT_QUAD, 50, 1000, NULL, NULL, NULL),
	m_widthGrowthAnimation(Animator::COMPONENT_WIDTH, Easing::OUT_ELASTIC, 200, 1000, NULL, NULL, NULL),
	m_heightShrinkAnimation(Animator::COMPONENT_HEIGHT, Easing::OUT_QUAD, 50, 1000, NULL, NULL, NULL),
	m_heightGrowthAnimation(Animator::COMPONENT_HEIGHT, Easing::OUT_ELASTIC, 200, 1000, NULL, NULL, NULL)
{
}
