; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.21005.1 
	...
	TITLE	C:\Users\Mathew\Dropbox\Muzzler\windows-sync\MuzzlerSync\libs\Aurora SDK\Lib\Source\A2DTextureX.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?GetClip@A2DTextureX@@UAEPAVA2DRect@@H@Z	; A2DTextureX::GetClip
PUBLIC	?SetClip@A2DTextureX@@UAEXPAVA2DRect@@H@Z	; A2DTextureX::SetClip
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\mathew\dropbox\muzzler\windows-sync\muzzlersync\libs\aurora sdk\lib\source\a2dtexturex.cpp
;	COMDAT ?SetClip@A2DTextureX@@UAEXPAVA2DRect@@H@Z
_TEXT	SEGMENT
tv296 = -216						; size = 4
tv244 = -216						; size = 4
tv196 = -216						; size = 4
...
_xClip$ = 8						; size = 4
_xIndex$ = 12						; size = 4
?SetClip@A2DTextureX@@UAEXPAVA2DRect@@H@Z PROC		; A2DTextureX::SetClip, COMDAT
; _this$ = ecx
...
; 8    : 	{
; 9    : 		aClips[xIndex].aX = 0.0f;

	mov	eax, DWORD PTR _xIndex$[ebp]
	shl	eax, 4
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [ecx+eax+48], xmm0

; 10   : 		aClips[xIndex].aY = 0.0f;
...
; 11   : 		aClips[xIndex].aWidth = aSize.aWidth;
...
; 12   : 		aClips[xIndex].aHeight = aSize.aHeight;
...
; 15   : 	}
; 16   : 
; 17   : 	// All values greater than zero but less than height/width
; 18   : 	aClips[xIndex].aX = min(max(xClip->aX, 0.0f), aSize.aWidth);
...
; 19   : 	aClips[xIndex].aY = min(max(xClip->aY, 0.0f), aSize.aHeight);
...
; 20   : 	aClips[xIndex].aWidth = min(max(xClip->aWidth, 0.0f), aSize.aWidth);
...
$LN17@SetClip:
	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [edx+8]
	comiss	xmm0, DWORD PTR tv216[ebp]
...
$LN21@SetClip:
	...
	movss	DWORD PTR [ecx+eax+40], xmm0

; 21   : 	aClips[xIndex].aHeight = min(max(xClip->aHeight, 0.0f), aSize.aHeight);
...
; 22   : }
	...
	pop	ebp
	ret	8
?SetClip@A2DTextureX@@UAEXPAVA2DRect@@H@Z ENDP		; A2DTextureX::SetClip
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\mathew\dropbox\muzzler\windows-sync\muzzlersync\libs\aurora sdk\lib\source\a2dtexturex.cpp
;	COMDAT ?GetClip@A2DTextureX@@UAEPAVA2DRect@@H@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_xIndex$ = 8						; size = 4
?GetClip@A2DTextureX@@UAEPAVA2DRect@@H@Z PROC		; A2DTextureX::GetClip, COMDAT
; _this$ = ecx
...
; 27   : }
	...
	pop	ebp
	ret	4
?GetClip@A2DTextureX@@UAEPAVA2DRect@@H@Z ENDP		; A2DTextureX::GetClip
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
