; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.21005.1 
	...
	TITLE	C:\Users\Mathew\Dropbox\Muzzler\windows-sync\MuzzlerSync\libs\Aurora SDK\Lib\Source\A2DMatrixFactory.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?createDefaultWorldMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@XZ ; A2DMatrixFactory::createDefaultWorldMatrix
PUBLIC	?createDefaultProjectionMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z ; A2DMatrixFactory::createDefaultProjectionMatrix
PUBLIC	?createDefaultOrthogonalMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z ; A2DMatrixFactory::createDefaultOrthogonalMatrix
...
EXTRN	_D3DXMatrixOrthoLH@20:PROC
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?createDefaultOrthogonalMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?createDefaultOrthogonalMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z$0
__ehfuncinfo$?createDefaultOrthogonalMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?createDefaultOrthogonalMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?createDefaultProjectionMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?createDefaultProjectionMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z$0
__ehfuncinfo$?createDefaultProjectionMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?createDefaultProjectionMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?createDefaultWorldMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@XZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?createDefaultWorldMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@XZ$0
__ehfuncinfo$?createDefaultWorldMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@XZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?createDefaultWorldMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@XZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\mathew\dropbox\muzzler\windows-sync\muzzlersync\libs\aurora sdk\lib\source\a2dmatrixfactory.cpp
;	COMDAT ?createDefaultOrthogonalMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z
_TEXT	SEGMENT
tv71 = -244						; size = 4
$T2 = -236						; size = 4
$T3 = -224						; size = 4
_orthogonalMatrix$ = -20				; size = 4
__$EHRec$ = -12						; size = 12
_xWindowProps$ = 8					; size = 4
?createDefaultOrthogonalMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z PROC ; A2DMatrixFactory::createDefaultOrthogonalMatrix, COMDAT
...
; 39   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?createDefaultOrthogonalMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	sub	esp, 232				; 000000e8H
	push	ebx
...
; 40   : 	// Create
; 41   : 	D3DXMATRIX * orthogonalMatrix;
; 42   : 
; 43   : 	// Set
; 44   : 	orthogonalMatrix = new D3DXMATRIX;
...
$LN4@createDefa:
	...
	mov	DWORD PTR _orthogonalMatrix$[ebp], ecx

; 45   : 
; 46   : 	// Initialize
; 47   : 	D3DXMatrixOrthoLH(orthogonalMatrix, ((float)xWindowProps->aRealWidth), ((float)xWindowProps->aRealHeight), xWindowProps->aScreenNear, xWindowProps->aScreenDepth);

	mov	eax, DWORD PTR _xWindowProps$[ebp]
	push	ecx
	...
	movss	DWORD PTR [esp], xmm0
	mov	edx, DWORD PTR _xWindowProps$[ebp]
	...
	push	ecx
	movss	DWORD PTR [esp], xmm0
	mov	ecx, DWORD PTR _orthogonalMatrix$[ebp]
	push	ecx
	call	_D3DXMatrixOrthoLH@20

; 48   : 
; 49   : 	// Return Pointer
; 50   : 	return orthogonalMatrix;

	mov	eax, DWORD PTR _orthogonalMatrix$[ebp]
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?createDefaultOrthogonalMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z$0:
	mov	eax, DWORD PTR $T3[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__ehhandler$?createDefaultOrthogonalMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-248]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?createDefaultOrthogonalMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?createDefaultOrthogonalMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z ENDP ; A2DMatrixFactory::createDefaultOrthogonalMatrix
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\mathew\dropbox\muzzler\windows-sync\muzzlersync\libs\aurora sdk\lib\source\a2dmatrixfactory.cpp
;	COMDAT ?createDefaultProjectionMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z
_TEXT	SEGMENT
tv76 = -268						; size = 4
$T2 = -260						; size = 4
$T3 = -248						; size = 4
_screenAspect$ = -44					; size = 4
_fieldOfView$ = -32					; size = 4
_projectionMatrix$ = -20				; size = 4
__$EHRec$ = -12						; size = 12
_xWindowProps$ = 8					; size = 4
?createDefaultProjectionMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z PROC ; A2DMatrixFactory::createDefaultProjectionMatrix, COMDAT
...
; 21   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?createDefaultProjectionMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 22   : 	// Create
; 23   : 	D3DXMATRIX * projectionMatrix;
; 24   : 	FLOAT fieldOfView, screenAspect;
; 25   : 
; 26   : 	// Set
; 27   : 	fieldOfView = ((float) D3DX_PI / 4.0f);

	movss	xmm0, DWORD PTR __real@3f490fdb
	movss	DWORD PTR _fieldOfView$[ebp], xmm0

; 28   : 	screenAspect = ((float) xWindowProps->aRealWidth) / ((float) xWindowProps->aRealHeight);
...
; 29   : 	projectionMatrix = new D3DXMATRIX;
...
$LN4@createDefa:
	...
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T2[ebp]
	mov	DWORD PTR _projectionMatrix$[ebp], ecx

; 30   : 
; 31   : 	// Initialize
; 32   : 	D3DXMatrixPerspectiveFovLH(projectionMatrix, fieldOfView, screenAspect, xWindowProps->aScreenNear, xWindowProps->aScreenDepth);
	...
	movss	DWORD PTR [esp], xmm0
	push	ecx
	movss	xmm0, DWORD PTR _fieldOfView$[ebp]
	movss	DWORD PTR [esp], xmm0
	mov	edx, DWORD PTR _projectionMatrix$[ebp]
	push	edx
	call	_D3DXMatrixPerspectiveFovLH@20

; 33   : 
; 34   : 	// Return Pointer
; 35   : 	return projectionMatrix;

	mov	eax, DWORD PTR _projectionMatrix$[ebp]
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?createDefaultProjectionMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z$0:
	mov	eax, DWORD PTR $T3[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__ehhandler$?createDefaultProjectionMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-272]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?createDefaultProjectionMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?createDefaultProjectionMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@PAUA2DWindowProperties@@@Z ENDP ; A2DMatrixFactory::createDefaultProjectionMatrix
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\mathew\dropbox\muzzler\windows-sync\muzzlersync\libs\aurora sdk\lib\source\a2dmatrixfactory.cpp
;	COMDAT ?createDefaultWorldMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@XZ
_TEXT	SEGMENT
tv71 = -244						; size = 4
$T2 = -236						; size = 4
$T3 = -224						; size = 4
_worldMatrix$ = -20					; size = 4
__$EHRec$ = -12						; size = 12
?createDefaultWorldMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@XZ PROC ; A2DMatrixFactory::createDefaultWorldMatrix, COMDAT
...
; 6    : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?createDefaultWorldMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@XZ
	mov	eax, DWORD PTR fs:0
	push	eax
	sub	esp, 232				; 000000e8H
	push	ebx
...
; 7    : 	// Create
; 8    : 	D3DXMATRIX * worldMatrix;
; 9    : 
; 10   : 	// Set
; 11   : 	worldMatrix = new D3DXMATRIX;
...
$LN4@createDefa:
	...
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T2[ebp]
	mov	DWORD PTR _worldMatrix$[ebp], ecx

; 12   : 
; 13   : 	// Initialize
; 14   : 	D3DXMatrixIdentity(worldMatrix);

	mov	eax, DWORD PTR _worldMatrix$[ebp]
	push	eax
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?createDefaultWorldMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@XZ$0:
	mov	eax, DWORD PTR $T3[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__ehhandler$?createDefaultWorldMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@XZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-248]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?createDefaultWorldMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@XZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?createDefaultWorldMatrix@A2DMatrixFactory@@SAPAUD3DXMATRIX@@XZ ENDP ; A2DMatrixFactory::createDefaultWorldMatrix
; Function compile flags: /Odtp /RTCsu /ZI
